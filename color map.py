...
scatter = axs[1].scatter(data['Temperature'], data['Humidity'], c=data['Time'].apply(lambda x: x.timestamp()), cmap='viridis', alpha=0.7)



# Add labels and legends for the second graph
axs[1].set_title('Scatter Plot: Temperature vs Humidity with Color by Time')
